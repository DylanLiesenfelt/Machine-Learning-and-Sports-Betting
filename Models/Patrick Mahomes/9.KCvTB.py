...
data = 'Models/Patrick Mahomes/PMahomes_Regular_Passing.csv' # Will need to change depending on where you have CSV
features = ['Age', 'Cmp', 'Att', 'Cmp%', 'TD', 'Int', 'Rate', 'Sk', 'Y/A']
target = ['Yds']

# Defense AVG STATS THIS SEASON: https://www.pro-football-reference.com/teams/tam/2024.htm#all_defense
games_played =  8

pass_att_allowed = (296)/games_played
pass_cmp_allowed = (199)/games_played
passYds_allowed = (2043)/games_played
passTD_allowed = (15)/games_played
def_int = (5)/games_played
def_sks = (21)/games_played

# QB AVG STATS THIS SEASON: https://www.pro-football-reference.com/players/M/MahoPa00/gamelog/2024/

games_started = 8

qb_age = 29.062 # Nov 4rd 2024
qb_cmp = (154)/games_started
qb_att = (225)/games_started
qb_yds = (1651)/games_started
qb_TD = (8)/games_started
qb_int = (9)/games_started
qb_rate = 84.9
qb_sk = 12/games_started
